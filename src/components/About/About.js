    ...
    render() { 
        return (
            <div className="about">
                <div>
                    <p>
                        <span>Hi there!,</span> I'm Aswanth, a BCA student with a passion for technology and a keen interest in exploring new areas of the industry. My experience in full-stack development, Android, and native app development has equipped me with a comprehensive set of skills that allows me to deliver quality work. With a strong foundation in programming languages like Java, Python, and C++, I am able to build robust and efficient applications that meet the client's requirements.
